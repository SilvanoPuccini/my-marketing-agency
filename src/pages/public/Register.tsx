...
const PLANS = [
  { value: 'solo', label: 'Solo', price: 'USD $26/mes', desc: '2 clientes · admin + 1' },
  { value: 'estudio', label: 'Estudio', price: 'USD $52/mes', desc: '5 clientes · admin + 4' },
  { value: 'casa', label: 'Casa', price: 'USD $104/mes', desc: '15 clientes · admin + 14' },
] as const
